...
*/
(function(r){Galleria.addTheme({name:"twelve",author:"Galleria",css:"galleria.twelve.css",defaults:{transition:"fadeslide",transitionSpeed:800,imageCrop:!1,thumbCrop:!0,carousel:!1,_locale:{show_thumbnails:"Show thumbnails",hide_thumbnails:"Hide thumbnails",play:"Play slideshow",pause:"Pause slideshow",enter_fullscreen:"Enter fullscreen",exit_fullscreen:"Exit fullscreen",popout_image:"Popout image",showing_image:"Showing image %s of %s"},_showFullscreen:!0,_showPopout:!0,_showProgress:!0,_showTooltip:!0},
...
p=function(){n.height(a.getStageHeight()).width(a.getStageWidth()).css("top",d?0:a.getStageHeight()+30,"opacity","0")},q=function(){d&&o?a.play():(o=g,a.pause());Galleria.utils.animate(n,{top:d?a.getStageHeight()+30:0,opacity:1},{easing:"galleria",duration:400,complete:function(){a.defineTooltip("thumblink",d?c.show_thumbnails:c.hide_thumbnails);i[d?"removeClass":"addClass"]("open");d=!d}})};p();b._showTooltip&&a.bindTooltip({thumblink:c.show_thumbnails,fullscreen:c.enter_fullscreen,play:c.play,popout:c.popout_image,caption:function(){var e=
...
this.bind("loadstart",function(a){a.cached||this.$("loader").show()});this.bind("loadfinish",function(){l.width(0);this.$("loader").hide();this.refreshTooltip("counter","caption")});this.bind("thumbnail",function(b){r(b.thumbTarget).hover(function(){a.setInfo(b.thumbOrder);a.setCounter(b.thumbOrder)},function(){a.setInfo();a.setCounter()}).click(function(){q()})});this.bind("fullscreen_enter",function(){m=!0;a.setOptions("transition","slide");f.addClass("open");h.css("bottom",0);this.defineTooltip("fullscreen",
