...
<?php ?>
<?php 
if(!is_page('press') && ( 'gallery' != get_post_type()) && !is_home()) {?>
...
<!--	<style>body.home, body.single-gallery {background:#fff; color:#000!important}#header {display: none!important}</style>-->
