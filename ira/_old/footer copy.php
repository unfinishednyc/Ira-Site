...
<?php // SOCIAL MEDIA BOX
	if('gallery' == get_post_type() && (!get_field('gallery_is_portfolio')) ) { ?>
	
<div class="gallerycontrols">

	<div>
		<div id="gallerybutton"><img src="<?php bloginfo('template_directory'); ?>/images/playbutton.gif"/></div>	
		<div id="sharebutton"><img src="<?php bloginfo('template_directory'); ?>/images/icon-share.png"/></div>	
		<div>
...
<script type="text/javascript">
    ...
    $('.medialist, .menu-main-container, .gallerycontrols').hover(function(){ 
        mouse_is_inside=true; 
    }, function(){ 
    ...
    $("body").click(function(){ 
        if(! mouse_is_inside) $('.menu-main-container').slideUp();
...
// HOME POST JAVASCRIPT-->
	...
	function submitFinished( response ) {
	  ...
	  if ( response == "success" ) {
	    ...
	    $('#friendName').val( "" );
	    $('#friendEmail').val( "" );
	    $('#emailform.toggle_container').delay(messageDelay).slideUp("slow" );
